  ...
  render() {
      if (this.state.isEditing) {
        ...
        <tr>
          ...
          <td><input placeholder={this.props.bike.type}
            name="type"
            type="text"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.mileage}
            name="mileage"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.chain}
            name="chain"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.chainring}
            name="chainring"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.cassette}
            name="cassette"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.pads}
            name="pads"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.lines}
            name="lines"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.front}
            name="front"
            type="number"
            onChange={this.handleInputChange}/></td>
          <td><input placeholder={this.props.bike.rear}
            name="rear"
            type="number"
            onChange={this.handleInputChange}/></td>
